...
<body>
	<h1>Page Scope</h1>
	Generate object of Counter1 in Page Scope use jsp:useBean<br>
	<jsp:useBean id="cob" class="com.lti.bean.Counter1" scope="page"></jsp:useBean>
	...
	<jsp:setProperty property="count" name="cob" value="100"/>
	name = object name
