...
<body>
	<h1>request scope</h1>
	Generate object of Counter1 in request scope use jsp:useBean<br>
	<jsp:useBean id="cob" class="com.lti.bean.Counter1" scope="request"></jsp:useBean>
	...
	<jsp:forward page="P10.jsp"></jsp:forward>
